...
class Game:
    ...
    def check_boundary_collision(self):
        if self.snake.block_x[0] < 0 or self.snake.block_x[0]+SIZE > 1000 or \
                self.snake.block_y[0] < 0 or self.snake.block_y[0]+SIZE > 800:
            raise "Game-Over"
